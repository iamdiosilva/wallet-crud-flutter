...
class AppTextStyles {
  ...
  static TextStyle listTileTransactionsData =
      const TextStyle(color: Colors.white54, fontSize: 12);
  static TextStyle listTileTransactionsValueCredit =
      const TextStyle(color: Color(0xff2BC48A), fontSize: 16);
  static TextStyle listTileTransactionsValueDebit =
  ...
  static TextStyle modalTransactionsTitle = const TextStyle(
      fontSize: 28, fontWeight: FontWeight.w400, color: Colors.white);

  static TextStyle alertDialogTitle = const TextStyle(
      fontSize: 18, fontWeight: FontWeight.w400, color: Colors.white);
  static TextStyle alertDialogContent =
  ...
  static TextStyle textDropDownMenu =
